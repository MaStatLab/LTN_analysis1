...
i = 1
n_or_a = 1
WORK_DIR = '/work/zw122/LTN_analysis1/'
...
data1dir=paste0(WORK_DIR,"/cache/ps_sim_100.rds")
...
if (!file.exists(paste0(resdir,'teststat/','i',i,'H',n_or_a,'r',r,'iter',niter,'_','v_post_norm.RData'))){
  ...
  input_data2=readRDS(paste0(data2dir,'sim',i,'H',n_or_a,'.rds'))
  # data
  cnt=input_data2$cnt
  data=t(cnt)
  n = ncol(data)
  ...
  saveRDS(v_post,paste0(resdir,'teststat/','i',i,'H',n_or_a,'r',r,'iter',niter,'_','v_post.rds'))
  saveRDS(v_post_norm,paste0(resdir,'teststat/','i',i,'H',n_or_a,'r',r,'iter',niter,'_','v_post_norm.rds'))
}
