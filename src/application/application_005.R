...
filenam=paste0(covariate,'_lambda',lambda,'_m005.rds')
...
# set prior proportion of significant associations to 0.05
mj = 0.05
pnull = (1 - mj)^99
...
saveRDS(result$gibbs_samples, paste0(resdir,'gibbs/',filenam))
}
